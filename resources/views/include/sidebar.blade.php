<aside class="sidebar layout-menu menu-vertical menu">
    ...
    <ul class="menu-inner align-items-center">
        ...
        <li class="menu-item {{ request()->routeIs('home') ? 'active' : '' }}">
            <a href="{{ route('home') }}" class="menu-link">
                <svg class="menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
        ...
        <!-- Builder -->
        <li class="menu-item {{ request()->routeIs('user_builders.index') ? 'active' : '' }}">
            <a href="{{ route('user_builders.index') }}" class="menu-link">
                <svg class="menu-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" />
                    <path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" />
        ...
        <!-- Products -->
        <li class="menu-item {{ request()->routeIs('showproduct') ? 'active' : '' }}">
