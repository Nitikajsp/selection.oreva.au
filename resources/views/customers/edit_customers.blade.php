            ...
            <div class="content-wrapper pl-30 ">
                ...
                <div class="flex-grow-1  container-fluid">
                    ...
                    <div class="page-header">
                        ...
                        <a href="{{ route('customers.show', $customer->id) }}" class="btn btn-primary btn-dark  rounded">
                            View
                        </a>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="state" class="form-select">
                                                <option value="New South Wales (NSW)"
                                                    ...
                                                    New South Wales (NSW)</option>
                                                <option value="Victoria (VIC)"
                                                    {{ old('state', $customer->state) == 'Victoria (VIC)' ? 'selected' : '' }}>
                                                    Victoria (VIC)</option>
                                                <option value="Queensland (QLD)"
                                                    {{ old('state', $customer->state) == 'Queensland (QLD)' ? 'selected' : '' }}>
                                                    Queensland (QLD)</option>
                                                <option value="Western Australia (WA)"
                                                    {{ old('state', $customer->state) == 'Western Australia (WA)' ? 'selected' : '' }}>
                                                    Western Australia (WA)</option>
                                                <option value="South Australia (SA)"
                                                    {{ old('state', $customer->state) == 'South Australia (SA)' ? 'selected' : '' }}>
                                                    South Australia (SA)</option>
                                                <option value="Tasmania (TAS)"
                                                    {{ old('state', $customer->state) == 'Tasmania (TAS)' ? 'selected' : '' }}>
                                                    Tasmania (TAS)</option>
                                                <option value="Australian Capital Territory (ACT)"
                                                    {{ old('state', $customer->state) == 'Australian Capital Territory (ACT)' ? 'selected' : '' }}>
                                                    Australian Capital Territory (ACT)</option>
                                                <option value="Northern Territory (NT)"
                                                    {{ old('state', $customer->state) == 'Northern Territory (NT)' ? 'selected' : '' }}>
                                                    Northern Territory (NT)</option>
                                            </select>
                                        </div>
                                    </div>
