                    ...
                    <table class="table datatables-projects" id="categorylist">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            <tr>
                                ...
                                {{-- <td class="d-flex flex-column justify-content-center align-items-start gap-1">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <a href="{{ route('editcategory', $category->id) }}" class="btn p-0 edit-btn">
                                        ...
                                        <form action="{{ route('destroycategory', $category->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn p-0 delete-btn text-danger" data-category-id="{{ $category->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal">
