<!doctype html>
<html lang="en" class="layout-compact layout-menu-100vh layout-menu-fixed layout-navbar-hidden" dir="ltr"
    data-theme="theme-default" data-assets-path="{{ asset_url() }}" data-template="vertical-menu-template"
    data-semidark-menu="true" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('libs/apex-charts/') }}" />
