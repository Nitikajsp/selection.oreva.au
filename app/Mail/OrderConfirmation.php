...
class OrderConfirmation extends Mailable
{
    ...
    public function build()
    {
        ...
        if ($list) {
            if (!empty($list->name)) $addressParts[] = $list->name;
            if (!empty($list->suburb)) $addressParts[] = $list->suburb;
            if (!empty($list->state)) $addressParts[] = $list->state;
            if (!empty($list->pincod)) $addressParts[] = $list->pincod;
        }
        ...
        return $this->subject($subject)
            ->html("
                ...
                <p>Please find attached the selected product list for your project.</p>
            ...
            ->attachData(
                $this->pdf,
                'Selection_Oreva_' . $this->orderData['list']->id . '.pdf',
